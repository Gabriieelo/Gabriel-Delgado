    ...
    <main>
      <section className="hero container" id="inicio">
        <div className="hero-copy">
          ...
          <div className="hero-actions"><a className="button button-primary" href="#proyectos">{t.projectsButton} <Arrow /></a><a className="button button-ghost" href="#sobre-mi">{t.know} <Arrow /></a></div>
        </div>
        <div className="hero-art" aria-hidden="true"><div className="art-grid" /><div className="orbit orbit-one" /><div className="orbit orbit-two" /><div className="art-core"><span>&lt;</span>GD<span>/&gt;</span></div><div className="art-caption">{language === 'es' ? 'DISEÑO' : 'DESIGN'} <span>×</span> {language === 'es' ? 'CÓDIGO' : 'CODE'}</div></div>
